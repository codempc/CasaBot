DESC_IO = [
    '{mortgage_type} or Interest Only loan is a loan in which the borrower '
...
DESC_LVR = [
    '{mortgage_type} or Loan to Value Ratio is calculated by dividing the loan amount '
    ...
    'The ratio of loan amount divided by the price of the property is {mortgage_type} or Loan Value Ratio.'
]
